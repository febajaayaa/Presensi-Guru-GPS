...
<div style="flex:1; margin-left:240px; padding:24px 28px;">
    ...
    <div style="display:flex; align-items:flex-start; gap:10px; background:#FFF7F7; border:1px solid #FECACA; border-left:4px solid #EF4444; border-radius:10px; padding:12px 16px; margin-bottom:20px;">
        ...
        <div>
            <div style="font-size:13px; font-weight:600; color:#B91C1C; margin-bottom:4px;">Ada {{ $errors->count() }} kesalahan:</div>
    ...
    <form method="POST" action="/admin/schools/{{ $school->id }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div style="background:white; border:1px solid #E2E8F0; border-radius:12px; overflow:hidden; margin-bottom:16px;">
            ...
            <div style="padding:20px; display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                ...
                <div style="grid-column:span 2;">
                    ...
                    <input type="text" name="nama_sekolah" value="{{ $school->nama_sekolah }}" required
                ...
                <div>
                    ...
                    <input type="text" name="npsn" value="{{ $school->npsn }}"
                ...
                <div>
                    ...
                    <select name="akreditasi"
                        ...
                        @foreach(['A','B','C','Belum Terakreditasi'] as $akr)
                        <option value="{{ $akr }}" {{ $school->akreditasi == $akr ? 'selected' : '' }}>{{ $akr }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="kepala_sekolah" value="{{ $school->kepala_sekolah }}"
                ...
                <div>
                    ...
                    <input type="text" name="no_telepon" value="{{ $school->no_telepon }}"
                ...
                <div>
                    ...
                    <input type="text" name="kota" value="{{ $school->kota }}"
                ...
                <div style="grid-column:span 2;">
                    ...
                    <textarea name="alamat" rows="3"
                        ...
                        onfocus="this.style.borderColor='#3B82F6'" onblur="this.style.borderColor='#D1D5DB'">{{ $school->alamat }}</textarea>
                </div>
                ...
                <div style="grid-column:span 2;">
                    ...
                    <textarea name="deskripsi" rows="2"
                        ...
                        style="width:100%; padding:9px 12px; border:1px solid #D1D5DB; border-radius:8px; font-size:13px; outline:none; box-sizing:border-box; resize:vertical;"
                        onfocus="this.style.borderColor='#3B82F6'" onblur="this.style.borderColor='#D1D5DB'">{{ $school->deskripsi }}</textarea>
                </div>
                    ...
                    <div style="display:flex; align-items:center; gap:16px; padding:14px 16px; background:#F8FAFC; border:1.5px dashed #CBD5E1; border-radius:10px;">
                        ...
                        <div style="flex:1;">
                            <label for="logoInput"
                                ...
                                {{ $school->logo ? 'Ganti Logo' : 'Pilih File Logo' }}
                            </label>
                            ...
                            <div id="logoFileName" style="font-size:11px; color:#94A3B8; margin-top:6px;">
                                {{ $school->logo ? 'Logo sudah ada — pilih file baru untuk mengganti' : 'Belum ada file dipilih' }}
                            </div>
                        </div>
                    </div>
                    @error('logo')
        ...
        <div style="background:white; border:1px solid #E2E8F0; border-radius:12px; overflow:hidden; margin-bottom:16px;">
            ...
            <div style="padding:20px; display:grid; grid-template-columns:1fr 1fr 1fr; gap:16px;">
                ...
                <div>
                    ...
                    <input type="text" name="latitude" value="{{ $school->latitude }}" required
                ...
                <div>
                    ...
                    <input type="text" name="longitude" value="{{ $school->longitude }}" required
                ...
                <div>
                    ...
                    <input type="number" name="radius" value="{{ $school->radius }}" required
                        placeholder="200"
                        style="width:100%; padding:9px 12px; border:1px solid #D1D5DB; border-radius:8px; font-size:13px; outline:none; box-sizing:border-box;"
                        onfocus="this.style.borderColor='#3B82F6'" onblur="this.style.borderColor='#D1D5DB'">
                </div>

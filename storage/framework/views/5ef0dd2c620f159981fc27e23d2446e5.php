...
<main style="flex:1; margin-left:240px; padding:32px 36px;">
 
    
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:32px;">
        <div>
            <h1 style="font-size:24px; font-weight:700; color:#0F172A; margin:0;">Beranda Super Admin</h1>
        </div>
        <div style="background:white; border-radius:10px; padding:10px 18px; box-shadow:0 1px 4px rgba(0,0,0,0.08); font-size:13px; color:#475569; display:flex; align-items:center; gap:8px;">
    ...
    <div style="display:grid; grid-template-columns:repeat(3,1fr); gap:20px; margin-bottom:28px;">
        ...
        <div style="background:white; border-radius:14px; padding:22px 24px; box-shadow:0 1px 6px rgba(0,0,0,0.07); border-top:4px solid #3B82F6;">
            <div style="display:flex; justify-content:space-between; align-items:flex-start;">
                <div>
                    ...
                    <div style="font-size:32px; font-weight:700; color:#0F172A;"><?php echo e(\App\Models\School::count()); ?></div>
                    <div style="font-size:12px; color:#3B82F6; margin-top:4px;">Sekolah terdaftar</div>
                </div>
                <div style="width:46px; height:46px; background:#EFF6FF; border-radius:12px; display:flex; align-items:center; justify-content:center;">
                    <i class="ti ti-building" style="font-size:22px; color:#3B82F6;"></i>
                </div>
            </div>
        </div>
 
        <div style="background:white; border-radius:14px; padding:22px 24px; box-shadow:0 1px 6px rgba(0,0,0,0.07); border-top:4px solid #8B5CF6;">
            <div style="display:flex; justify-content:space-between; align-items:flex-start;">
                <div>
                    ...
                    <div style="font-size:32px; font-weight:700; color:#0F172A;"><?php echo e(\App\Models\User::count()); ?></div>
                    <div style="font-size:12px; color:#8B5CF6; margin-top:4px;">Akun aktif</div>
                </div>
                <div style="width:46px; height:46px; background:#F5F3FF; border-radius:12px; display:flex; align-items:center; justify-content:center;">
                    <i class="ti ti-users" style="font-size:22px; color:#8B5CF6;"></i>
                </div>
            </div>
        </div>
 
        <div style="background:white; border-radius:14px; padding:22px 24px; box-shadow:0 1px 6px rgba(0,0,0,0.07); border-top:4px solid #10B981;">
            <div style="display:flex; justify-content:space-between; align-items:flex-start;">
                <div>
                    <div style="font-size:12px; color:#64748B; text-transform:uppercase; letter-spacing:0.06em; margin-bottom:8px;">Total Admin</div>
                    <div style="font-size:32px; font-weight:700; color:#0F172A;"><?php echo e(\App\Models\User::where('role', 'admin')->count()); ?></div>
                    <div style="font-size:12px; color:#10B981; margin-top:4px;">Admin sekolah</div>
                </div>
                <div style="width:46px; height:46px; background:#F0FDF4; border-radius:12px; display:flex; align-items:center; justify-content:center;">
    ...
    <div style="background:white; border-radius:14px; padding:24px 28px; box-shadow:0 1px 6px rgba(0,0,0,0.07);">
        ...
        <table style="width:100%; border-collapse:collapse; font-size:13px;">
            ...
            <tbody>
                <?php $__currentLoopData = \App\Models\User::latest()->take(5)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr style="border-bottom:1px solid #F1F5F9;">
                    <td style="padding:12px 14px; color:#94A3B8;"><?php echo e($i + 1); ?></td>
                    <td style="padding:12px 14px; color:#1E293B; font-weight:500;"><?php echo e($user->name); ?></td>
                    <td style="padding:12px 14px; color:#475569;"><?php echo e($user->email); ?></td>
...
<?php endif; ?><?php /**PATH D:\presensi-app\resources\views/superadmin/beranda.blade.php ENDPATH**/ ?>
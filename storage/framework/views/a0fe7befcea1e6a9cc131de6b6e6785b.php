...
<div style="flex:1; margin-left:240px; padding:24px 28px;">
    ...
    <div style="margin-bottom:20px;">
        ...
        <p class="text-xs text-gray-500 mt-0.5">Total <strong><?php echo e($users->count()); ?></strong> akun terdaftar di sistem</p>
    </div>
    ...
    <div style="display:grid; grid-template-columns:repeat(4,1fr); gap:12px; margin-bottom:20px;">
        <div style="background:white; border:1px solid #E2E8F0; border-top:3px solid #8B5CF6; border-radius:10px; padding:14px 16px;">
            ...
            <div style="font-size:28px; font-weight:700; color:#8B5CF6; margin-top:4px;"><?php echo e($schools->count()); ?></div>
        ...
        <div style="background:white; border:1px solid #E2E8F0; border-top:3px solid #3B82F6; border-radius:10px; padding:14px 16px;">
            ...
            <div style="font-size:28px; font-weight:700; color:#1E293B; margin-top:4px;"><?php echo e($users->count()); ?></div>
        ...
        <div style="background:white; border:1px solid #E2E8F0; border-top:3px solid #10B981; border-radius:10px; padding:14px 16px;">
            ...
            <div style="font-size:28px; font-weight:700; color:#10B981; margin-top:4px;"><?php echo e($users->where('role','admin')->count()); ?></div>
        ...
        <div style="background:white; border:1px solid #E2E8F0; border-top:3px solid #F59E0B; border-radius:10px; padding:14px 16px;">
            ...
            <div style="font-size:28px; font-weight:700; color:#F59E0B; margin-top:4px;"><?php echo e($users->where('role','guru')->count()); ?></div>
        ...
        <table style="width:100%; border-collapse:collapse; font-size:13px;" id="userTable">
            ...
            <tbody>
                ...
                <tr style="border-bottom:1px solid #F1F5F9;" onmouseover="this.style.background='#F8FAFC'" onmouseout="this.style.background='white'">
                    <td style="padding:14px 16px; color:#94A3B8;"><?php echo e($i + 1); ?></td>

                    
                    <td style="padding:14px 16px;">
                        <div style="display:flex; align-items:center; gap:10px;">
                            <div style="width:34px; height:34px; border-radius:50%; background:<?php echo e(['#3B82F6','#10B981','#F59E0B','#8B5CF6','#EF4444'][($i % 5)]); ?>; display:flex; align-items:center; justify-content:center; color:white; font-size:12px; font-weight:600; flex-shrink:0;">
                                <?php echo e(strtoupper(substr($u->name,0,1))); ?>

                            </div>
                            <div>
                                <div style="font-weight:500; color:#1E293B;"><?php echo e($u->name); ?></div>
                                <div style="font-size:11px; color:#94A3B8;"><?php echo e(ucfirst($u->role)); ?></div>
                            </div>
                        </div>
                    </td>

                    
                    <td style="padding:14px 16px; color:#64748B;"><?php echo e($u->email); ?></td>
                    ...
                    <td style="padding:14px 16px;">
                        <?php if($u->school): ?>
                            <span style="display:inline-flex; align-items:center; gap:5px; font-size:12px; background:#EFF6FF; color:#1D4ED8; padding:4px 10px; border-radius:20px; border:1px solid #BFDBFE;">
                                ...
                                <?php echo e($u->school->nama_sekolah); ?>
                    ...
                    <td style="padding:14px 16px; text-align:center;">
                        ...
                        <?php else: ?>
                            <div style="display:flex; align-items:center; justify-content:center; gap:6px; flex-wrap:wrap;">
                                ...
                                <button
                                    onclick="openEditModal(<?php echo e($u->id); ?>, '<?php echo e(addslashes($u->name)); ?>', '<?php echo e($u->role); ?>', <?php echo e($u->school_id ?? 'null'); ?>)"
                                ...
                                <?php if($u->role === 'guru'): ?>
                                <form action="<?php echo e(route('admin.users.makeAdmin', $u->id)); ?>" method="POST" style="display:inline;">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit"
                                ...
                                <form action="<?php echo e(route('admin.users.delete', $u->id)); ?>" method="POST" style="display:inline;"
                                      onsubmit="return confirm('Hapus akun <?php echo e(addslashes($u->name)); ?>?')">
                                    <?php echo csrf_field(); ?>
            ...
            <div style="padding:20px 24px;">
                ...
                <div style="margin-bottom:4px;">
                    ...
                    <select name="school_id" id="modalSchool"
                        ...
                        <option value="<?php echo e($school->id); ?>"><?php echo e($school->nama_sekolah); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
...
<?php endif; ?><?php /**PATH D:\presensi-app\resources\views/admin/users.blade.php ENDPATH**/ ?>
...
<div style="display:flex; min-height:100vh; background:#F0F4F8; font-family:'Inter',sans-serif;">
    ...
    <main style="margin-left:240px; flex:1; padding:32px 36px; min-height:100vh; max-width:900px;">
        ...
        <nav style="display:flex; align-items:center; gap:6px; font-size:12px; color:#64748B; margin-bottom:24px;">
            <a href="<?php echo e(route('admin.dashboard')); ?>" style="color:#3B82F6; text-decoration:none; font-weight:500;">Beranda</a>
            <i class="ti ti-chevron-right" style="font-size:12px; color:#CBD5E1;"></i>
            <a href="<?php echo e(route('guru.index')); ?>" style="color:#3B82F6; text-decoration:none; font-weight:500;">Data Guru</a>
            <i class="ti ti-chevron-right" style="font-size:12px; color:#CBD5E1;"></i>
        ...
        <div style="background:#FEF2F2; border:1px solid #FECACA; border-radius:10px; padding:13px 16px; font-size:13px; color:#991B1B; display:flex; align-items:flex-start; gap:9px; margin-bottom:20px;">
            ...
            <div>
                <div style="font-weight:600; margin-bottom:5px;">Ada <?php echo e($errors->count()); ?> kesalahan yang perlu diperbaiki:</div>
        ...
        <div style="background:#ffffff; border:1px solid #E2E8F0; border-radius:16px; overflow:hidden;">
            ...
            <form method="POST"
                  action="<?php echo e(route('guru.update', $guru->id)); ?>"
                  id="editForm"
                    ...
                    <div style="display:grid; grid-template-columns:1fr; gap:22px;">
                        ...
                        <div style="display:flex; flex-direction:column; gap:7px;">
                            ...
                            <div style="position:relative;">
                                ...
                                <input type="text"
                                       id="name" name="name"
                                       value="<?php echo e(old('name', $guru->name)); ?>"
                                       placeholder="Masukkan nama lengkap"
                                       oninput="markChanged()"
                                       style="width:100%; height:42px; border:1.5px solid <?php echo e($errors->has('name') ? '#EF4444' : '#E2E8F0'); ?>; border-radius:9px; padding:0 14px 0 38px; font-size:13px; color:#0F172A; background:#FAFAFA; outline:none; box-sizing:border-box; transition:border-color .15s;"
                                       onfocus="this.style.borderColor='#3B82F6'; this.style.background='#fff'; this.style.boxShadow='0 0 0 3px rgba(59,130,246,0.1)'"
                                       onblur="this.style.borderColor='<?php echo e($errors->has('name') ? '#EF4444' : '#E2E8F0'); ?>'; this.style.background='#FAFAFA'; this.style.boxShadow='none'">
                            </div>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                <span style="font-size:11px; color:#EF4444; display:flex; align-items:center; gap:4px;">
                                    <i class="ti ti-alert-circle" style="font-size:12px;"></i><?php echo e($message); ?>
                        ...
                        <div style="display:flex; flex-direction:column; gap:7px;">
                            ...
                            <div style="position:relative;">
                                ...
                                <input type="email"
                                       ...
                                       oninput="markChanged()"
                                       style="width:100%; height:42px; border:1.5px solid <?php echo e($errors->has('email') ? '#EF4444' : '#E2E8F0'); ?>; border-radius:9px; padding:0 14px 0 38px; font-size:13px; color:#0F172A; background:#FAFAFA; outline:none; box-sizing:border-box; transition:border-color .15s;"
                                       onfocus="this.style.borderColor='#3B82F6'; this.style.background='#fff'; this.style.boxShadow='0 0 0 3px rgba(59,130,246,0.1)'"
                                       onblur="this.style.borderColor='<?php echo e($errors->has('email') ? '#EF4444' : '#E2E8F0'); ?>'; this.style.background='#FAFAFA'; this.style.boxShadow='none'">
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div style="display:flex; flex-direction:column; gap:7px;">
                            ...
                            <div style="display:flex; align-items:center; gap:10px; height:42px; border:1.5px solid #E2E8F0; border-radius:9px; padding:0 14px 0 38px; background:#F1F5F9; position:relative;">
                                ...
                                <span style="font-size:13px; color:#475569;"><?php echo e($guru->school->nama_sekolah ?? '-'); ?></span>
                            ...
                            <input type="hidden" name="school_id" value="<?php echo e($guru->school_id); ?>">
                        </div>
                        ...
                        <div style="display:flex; flex-direction:column; gap:7px;">
                            ...
                            <div style="position:relative;">
                                ...
                                <input type="password"
                                       ...
                                       oninput="markChanged()"
                                       style="width:100%; height:42px; border:1.5px solid <?php echo e($errors->has('password') ? '#EF4444' : '#E2E8F0'); ?>; border-radius:9px; padding:0 44px 0 38px; font-size:13px; color:#0F172A; background:#FAFAFA; outline:none; box-sizing:border-box; transition:border-color .15s;"
                                       onfocus="this.style.borderColor='#3B82F6'; this.style.background='#fff'; this.style.boxShadow='0 0 0 3px rgba(59,130,246,0.1)'"
                                       onblur="this.style.borderColor='<?php echo e($errors->has('password') ? '#EF4444' : '#E2E8F0'); ?>'; this.style.background='#FAFAFA'; this.style.boxShadow='none'">
...
<?php endif; ?><?php /**PATH D:\presensi-app\resources\views/admin/guru/edit.blade.php ENDPATH**/ ?>
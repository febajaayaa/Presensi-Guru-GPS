...
<main style="flex:1; margin-left:220px; min-height:100vh; display:flex; flex-direction:column;">
    ...
    <div style="padding:28px 32px; flex:1;">
        ...
        <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:24px;">
            <div>
                <div style="display:flex; align-items:center; gap:6px; margin-bottom:6px; font-size:12px; color:#94A3B8;">
                    <a href="<?php echo e(route('izin.form')); ?>" style="color:#3B82F6; text-decoration:none; display:flex; align-items:center; gap:4px;"
        ...
        <div style="display:flex; align-items:center; gap:10px; background:#FEF2F2; border:1px solid #FECACA; border-left:4px solid #EF4444; border-radius:10px; padding:12px 16px; margin-bottom:16px;">
            ...
            <span style="font-size:13px; font-weight:500; color:#B91C1C;"><?php echo e(session('error')); ?></span>
        </div>
        <?php endif; ?>
        <?php if($errors->any()): ?>
        ...
        <div style="display:grid; grid-template-columns:1fr 72px; gap:20px; align-items:start;">
            ...
            <div style="background:white; border-radius:16px; border:1px solid #E2E8F0; overflow:hidden; box-shadow:0 1px 4px rgba(0,0,0,0.05);">
                ...
                <form method="POST" action="<?php echo e(route('izin.store')); ?>" style="padding:24px;">
                    <?php echo csrf_field(); ?>
                    ...
                    <div style="margin-bottom:20px;">
                        ...
                        <div style="position:relative;">
                            <select name="status" required
                                ...
                                <option value="izin_sakit"    <?php echo e(old('status')=='izin_sakit'    ? 'selected':''); ?>>Izin Sakit</option>
                                <option value="izin_keluarga" <?php echo e(old('status')=='izin_keluarga' ? 'selected':''); ?>>Izin Keluarga</option>
                                <option value="izin_dinas"    <?php echo e(old('status')=='izin_dinas'    ? 'selected':''); ?>>Izin Dinas / Tugas</option>
                                <option value="izin_pribadi"  <?php echo e(old('status')=='izin_pribadi'  ? 'selected':''); ?>>Izin Keperluan Pribadi</option>
                                <option value="izin_lainnya"  <?php echo e(old('status')=='izin_lainnya'  ? 'selected':''); ?>>Lainnya</option>
                            </select>
                        </div>
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px; margin-bottom:6px;">
                        <div>
                            ...
                            <input type="date" name="tanggal_mulai" id="tanggal_mulai" required
                                   value="<?php echo e(old('tanggal_mulai', now()->toDateString())); ?>"
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_selesai" id="tanggal_selesai"
                                   value="<?php echo e(old('tanggal_selesai', now()->toDateString())); ?>"
                                   min="<?php echo e(now()->toDateString()); ?>"
                                   style="width:100%; padding:10px 12px; border:1px solid #D1D5DB; border-radius:8px; font-size:13px; color:#374151; outline:none; box-sizing:border-box;"
                                   onfocus="this.style.borderColor='#3B82F6';this.style.boxShadow='0 0 0 3px rgba(59,130,246,0.1)'"
                                   onblur="this.style.borderColor='#D1D5DB';this.style.boxShadow='none'"
                    ...
                    <div style="margin-bottom:20px;">
                        ...
                        <textarea name="keterangan" rows="4" maxlength="1000" required
                                  ...
                                  onfocus="this.style.borderColor='#3B82F6';this.style.boxShadow='0 0 0 3px rgba(59,130,246,0.1)'"
                                  onblur="this.style.borderColor='#D1D5DB';this.style.boxShadow='none'"><?php echo e(old('keterangan')); ?></textarea>
                        <p style="font-size:11px; color:#9CA3AF; margin-top:5px;">
                            <i class="ti ti-info-circle" style="font-size:11px;"></i>
                    ...
                    <div style="margin-bottom:24px;">
                        ...
                        <textarea name="catatan" rows="2"
                                  ...
                                  style="width:100%; padding:10px 12px; border:1px solid #D1D5DB; border-radius:8px; font-size:13px; color:#374151; resize:vertical; box-sizing:border-box; outline:none; font-family:inherit; line-height:1.5;"
                                  onfocus="this.style.borderColor='#3B82F6';this.style.boxShadow='0 0 0 3px rgba(59,130,246,0.1)'"
                                  onblur="this.style.borderColor='#D1D5DB';this.style.boxShadow='none'"><?php echo e(old('catatan')); ?></textarea>
                    </div>

                    
                    <div style="display:flex; align-items:center; justify-content:flex-end; gap:10px; border-top:1px solid #F1F5F9; padding-top:20px;">
                        <a href="<?php echo e(route('izin.form')); ?>"
                    ...
                    <div id="panel-jenis"
                        ...
                        <div style="padding:12px 14px; display:flex; flex-direction:column; gap:7px;">
                            ...
                            <div style="display:flex; align-items:center; gap:10px; padding:8px 10px; background:#F8FAFC; border-radius:8px;">
                                <div style="width:30px; height:30px; background:<?php echo e($jenis['bg']); ?>; border-radius:7px; display:flex; align-items:center; justify-content:center; flex-shrink:0;">
                                    <i class="ti <?php echo e($jenis['icon']); ?>" style="font-size:14px; color:<?php echo e($jenis['color']); ?>;"></i>
                                </div>
                                <div>
...
<?php endif; ?><?php /**PATH D:\presensi-app\resources\views/user/izin/create.blade.php ENDPATH**/ ?>
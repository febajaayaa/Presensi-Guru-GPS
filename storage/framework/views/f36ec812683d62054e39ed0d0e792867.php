...
<main style="flex:1; margin-left:220px; min-height:100vh; display:flex; flex-direction:column;">
    ...
    <div style="padding:24px; flex:1;">
        ...
        <div class="flex flex-wrap gap-4 mb-4">
            ...
            ?>
            <?php $__currentLoopData = $legends; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex items-center gap-1.5 text-xs text-gray-500">
                <div class="w-2.5 h-2.5 rounded-full flex-shrink-0" style="background:<?php echo e($leg['color']); ?>"></div>
                <?php echo e($leg['label']); ?>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            ...
            <div class="grid grid-cols-7 text-center mb-2">
                <?php $__currentLoopData = ['Min','Sen','Sel','Rab','Kam','Jum','Sab']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="text-[11px] font-medium py-1 <?php echo e($i === 0 ? 'text-red-500' : 'text-gray-400'); ?>">
                    <?php echo e($day); ?>
...
<script>
const presensiData = <?php echo json_encode($presensis, 15, 512) ?>;
...
<?php endif; ?><?php /**PATH D:\presensi-app\resources\views/presensi/kalender.blade.php ENDPATH**/ ?>
...
<main style="flex:1; margin-left:220px; min-height:100vh; display:flex; flex-direction:column;">
    ...
    <div style="padding:24px; flex:1;">
        ...
        <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:20px;">
            ...
            <a href="<?php echo e(route('izin.create')); ?>"
            ...
            <div style="background:white; border-radius:12px; border:1px solid #E2E8F0; border-top:3px solid #3B82F6; padding:16px 18px; box-shadow:0 1px 4px rgba(0,0,0,0.05);">
                <div style="display:flex; justify-content:space-between; align-items:center;">
                    <div>
                        ...
                        <div style="font-size:28px; font-weight:700; color:#2563EB;"><?php echo e($izins->count()); ?></div>
                    </div>
            ...
            <div style="background:white; border-radius:12px; border:1px solid #E2E8F0; border-top:3px solid #10B981; padding:16px 18px; box-shadow:0 1px 4px rgba(0,0,0,0.05);">
                <div style="display:flex; justify-content:space-between; align-items:center;">
                    <div>
                        ...
                        <div style="font-size:28px; font-weight:700; color:#10B981;"><?php echo e($izins->where('status','disetujui')->count()); ?></div>
                    </div>
            ...
            <div style="background:white; border-radius:12px; border:1px solid #E2E8F0; border-top:3px solid #F59E0B; padding:16px 18px; box-shadow:0 1px 4px rgba(0,0,0,0.05);">
                <div style="display:flex; justify-content:space-between; align-items:center;">
                    <div>
                        ...
                        <div style="font-size:28px; font-weight:700; color:#F59E0B;"><?php echo e($izins->whereIn('status',['pending','menunggu'])->count()); ?></div>
                    </div>
        ...
        <div style="background:white; border-radius:12px; border:1px solid #E2E8F0; overflow:hidden; box-shadow:0 1px 4px rgba(0,0,0,0.05);">
                    ...
                    <tr style="border-bottom:1px solid #F1F5F9;" onmouseover="this.style.background='#F8FAFF'" onmouseout="this.style.background='white'">
                        <td style="padding:13px 16px;">
                            <span style="display:inline-flex; align-items:center; padding:4px 10px; border-radius:6px; font-size:12px; font-weight:600; background:#EFF6FF; color:#1D4ED8; border:1px solid #BFDBFE;">
                                <?php echo e(ucfirst($izin->jenis ?? $izin->status ?? 'Izin')); ?>

                            </span>
                        </td>
                        <td style="padding:13px 16px; font-weight:500; color:#1E293B;">
                            <?php echo e(\Carbon\Carbon::parse($izin->tanggal_mulai)->translatedFormat('d M Y')); ?>

                        </td>
                        <td style="padding:13px 16px; color:#1E293B;">
                            <?php echo e($izin->tanggal_selesai ? \Carbon\Carbon::parse($izin->tanggal_selesai)->translatedFormat('d M Y') : '-'); ?>

                        </td>
                        <td style="padding:13px 16px; color:#64748B; max-width:240px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;" title="<?php echo e($izin->keterangan); ?>">
                            <?php echo e($izin->keterangan ?? '-'); ?>

                        </td>
                        <td style="padding:13px 16px;">
                            <?php if(in_array($izin->status, ['pending','menunggu'])): ?>
            ...
            <div style="padding:12px 16px; border-top:1px solid #F1F5F9; background:#FAFBFF;">
                <p style="font-size:12px; color:#94A3B8; margin:0;">Menampilkan <?php echo e($izins->count()); ?> data</p>
            </div>
        </div>
...
<?php endif; ?><?php /**PATH D:\presensi-app\resources\views/user/izin/form.blade.php ENDPATH**/ ?>
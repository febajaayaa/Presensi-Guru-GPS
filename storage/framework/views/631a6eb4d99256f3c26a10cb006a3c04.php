...
<div style="flex:1; margin-left:240px; padding:24px 28px;">
    ...
    <div role="alert" style="display:flex; align-items:center; gap:10px; background:#F0FDF4; border:1px solid #86EFAC; border-left:4px solid #22C55E; border-radius:10px; padding:12px 16px; margin-bottom:20px;">
        ...
        <div>
            ...
            <div style="font-size:12px; color:#166534;"><?php echo e(session('success')); ?></div>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div role="alert" style="display:flex; align-items:flex-start; gap:10px; background:#FFF7F7; border:1px solid #FECACA; border-left:4px solid #EF4444; border-radius:10px; padding:12px 16px; margin-bottom:20px;">
        ...
        <div>
            <div style="font-size:13px; font-weight:600; color:#B91C1C; margin-bottom:4px;">Ada <?php echo e($errors->count()); ?> kesalahan yang perlu diperbaiki:</div>
            ...
            <div style="margin-bottom:28px;">
                ...
                <div style="margin-bottom:16px;">
                    ...
                    <input type="text" id="nama_sekolah" name="nama_sekolah"
                        ...
                        style="width:100%; padding:10px 12px; border:1.5px solid <?php echo e($errors->has('nama_sekolah') ? '#EF4444' : '#D1D5DB'); ?>; border-radius:8px; font-size:13px; color:#1E293B; outline:none; box-sizing:border-box;"
                        onfocus="this.style.borderColor='#3B82F6'; this.style.boxShadow='0 0 0 3px rgba(59,130,246,0.12)'"
                        onblur="this.style.borderColor='<?php echo e($errors->has('nama_sekolah') ? '#EF4444' : '#D1D5DB'); ?>'; this.style.boxShadow='none'">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div style="margin-bottom:16px;">
                    ...
                    <input type="text" id="npsn" name="npsn"
                        value="<?php echo e(old('npsn')); ?>"
                        placeholder="Contoh: 20307355"
                        maxlength="8"
                        inputmode="numeric"
                        style="width:100%; padding:10px 12px; border:1.5px solid <?php echo e($errors->has('npsn') ? '#EF4444' : '#D1D5DB'); ?>; border-radius:8px; font-size:13px; color:#1E293B; outline:none; box-sizing:border-box;"
                        onfocus="this.style.borderColor='#3B82F6'; this.style.boxShadow='0 0 0 3px rgba(59,130,246,0.12)'"
                        onblur="this.style.borderColor='<?php echo e($errors->has('npsn') ? '#EF4444' : '#D1D5DB'); ?>'; this.style.boxShadow='none'">
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        <p style="margin:3px 0 0; font-size:11px; color:#EF4444;">⚠ <?php echo e($message); ?></p>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                ...
                <div style="margin-bottom:16px;">
                    ...
                    <input type="text" id="kepala_sekolah" name="kepala_sekolah"
                        value="<?php echo e(old('kepala_sekolah')); ?>"
            ...
            <div style="margin-bottom:28px;">
                ...
                <div style="margin-bottom:16px;">
                    ...
                    <textarea id="alamat" name="alamat" rows="2"
                        ...
                        style="width:100%; padding:10px 12px; border:1.5px solid <?php echo e($errors->has('alamat') ? '#EF4444' : '#D1D5DB'); ?>; border-radius:8px; font-size:13px; color:#1E293B; outline:none; box-sizing:border-box; resize:vertical; line-height:1.5;"
                        onfocus="this.style.borderColor='#3B82F6'; this.style.boxShadow='0 0 0 3px rgba(59,130,246,0.12)'"
                        onblur="this.style.borderColor='<?php echo e($errors->has('alamat') ? '#EF4444' : '#D1D5DB'); ?>'; this.style.boxShadow='none'"><?php echo e(old('alamat')); ?></textarea>
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:12px; margin-bottom:16px;">
                    <div>
                        ...
                        <input type="text" id="latitude" name="latitude"
                            ...
                            inputmode="decimal"
                            style="width:100%; padding:10px 12px; border:1.5px solid <?php echo e($errors->has('latitude') ? '#EF4444' : '#D1D5DB'); ?>; border-radius:8px; font-size:13px; color:#1E293B; outline:none; box-sizing:border-box;"
                            onfocus="this.style.borderColor='#3B82F6'; this.style.boxShadow='0 0 0 3px rgba(59,130,246,0.12)'"
                            onblur="this.style.borderColor='<?php echo e($errors->has('latitude') ? '#EF4444' : '#D1D5DB'); ?>'; this.style.boxShadow='none'">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="longitude" name="longitude"
                            ...
                            inputmode="decimal"
                            style="width:100%; padding:10px 12px; border:1.5px solid <?php echo e($errors->has('longitude') ? '#EF4444' : '#D1D5DB'); ?>; border-radius:8px; font-size:13px; color:#1E293B; outline:none; box-sizing:border-box;"
                            onfocus="this.style.borderColor='#3B82F6'; this.style.boxShadow='0 0 0 3px rgba(59,130,246,0.12)'"
                            onblur="this.style.borderColor='<?php echo e($errors->has('longitude') ? '#EF4444' : '#D1D5DB'); ?>'; this.style.boxShadow='none'">
                ...
                <div>
                    ...
                    <div style="position:relative; max-width:200px;">
                        <input type="number" id="radius" name="radius"
                            value="<?php echo e(old('radius')); ?>"
                            placeholder="Contoh: 100"
                            min="10" max="5000" step="10"
                            style="width:100%; padding:10px 40px 10px 12px; border:1.5px solid <?php echo e($errors->has('radius') ? '#EF4444' : '#D1D5DB'); ?>; border-radius:8px; font-size:13px; color:#1E293B; outline:none; box-sizing:border-box;"
                            onfocus="this.style.borderColor='#3B82F6'; this.style.boxShadow='0 0 0 3px rgba(59,130,246,0.12)'"
                            onblur="this.style.borderColor='<?php echo e($errors->has('radius') ? '#EF4444' : '#D1D5DB'); ?>'; this.style.boxShadow='none'">
...
<?php endif; ?><?php /**PATH D:\presensi-app\resources\views/admin/create-school.blade.php ENDPATH**/ ?>